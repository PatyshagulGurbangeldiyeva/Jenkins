...
public class DashboardSteps extends CommonMethods{
	...
	@Then ("user sees dahboard menu is displayed")    // import io.cucumber.datatable.DataTable;
	public void user_sees_dahboard_menu_is_displayed(DataTable dashboardMenu) {
